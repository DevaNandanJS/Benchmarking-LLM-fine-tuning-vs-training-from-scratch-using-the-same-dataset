...
Outputs (relative to repo root):
  data/processed/track2_train.pt          — {input_ids, labels} LongTensor[N,256]
  data/processed/track2_val.pt            — same schema, val chunks
...
# Copied from track1_finetune/scripts/build_dataset.py — no Track 1 imports.
...
def _write_split_strategy(
    ...
    **Script:** `track2_scratch/scripts/build_dataset.py`
