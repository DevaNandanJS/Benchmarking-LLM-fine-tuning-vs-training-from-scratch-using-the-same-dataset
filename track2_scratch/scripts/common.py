...
Mirrors track1_finetune/scripts/common.py exactly in interface but with
TRACK_DIR pointing to track2_scratch/ — this is intentional and critical.
Do NOT import track1's common.py from here: its TRACK_DIR would resolve to
track1_finetune/, routing all logs and configs to the wrong track.
...
# Resolve upward: scripts/ → track2_scratch/ → llm_task/
...
def path(rel: str) -> Path:
    """Resolve a path relative to track2_scratch/ (robust to CWD)."""
