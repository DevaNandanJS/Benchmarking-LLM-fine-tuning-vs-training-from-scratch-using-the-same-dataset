...
Outputs (relative to repo root):
    track2_scratch/configs/run_phase4_<run_name>.json        \u2014 config dump pre-training
    track2_scratch/logs/<run_name>/metrics.jsonl             \u2014 step-level logging
    ...
    track2_scratch/checkpoints/last/<run_name>/last_ckpt.pt  \u2014 audit artifact
...
def main() -> None:
    ...
    # without requiring track2_train.pt / track2_val.pt (those only exist after
