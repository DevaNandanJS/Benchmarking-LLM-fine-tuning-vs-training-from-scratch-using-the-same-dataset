...
with open('track2_scratch/track2_run.ipynb', encoding='utf-8') as f:
    nb = json.load(f)
...
phase5_md = [
    ...
    '- `track2_scratch/eval/sweep_results.csv` (written by train.py)\n',
    '- `track2_scratch/checkpoints/best_val/<run>/best_val.pt` (best checkpoint)\n',
    '- `data/processed/track2_val.pt` (val tensors from Phase 2)\n',
    '- `data/processed/track2_dataset_stats.json` (must contain `split_boundary_token_idx`)\n',
    '\n',
    '**Outputs produced:**\n',
    '- `track2_scratch/eval/loss_curve.png` -- train/val curves for all 3 sweep runs\n',
    '- `track2_scratch/eval/final_metrics.json` -- CE loss, perplexity, BPB\n',
    '- `track2_scratch/eval/loss_curve_interpretation.md` -- templated interpretation\n',
    '\n',
...
phase5_smoke_src = [
    ...
    '!python track2_scratch/scripts/eval.py --smoke-test',
]
...
phase5_run_src = [
    ...
    '!python track2_scratch/scripts/eval.py',
]
...
phase5_inspect_src = [
    ...
    '\n',
    "metrics = _json.load(open('track2_scratch/eval/final_metrics.json'))\n",
    ...
    "print(open('track2_scratch/eval/loss_curve_interpretation.md').read())\n",
]
...
phase6_md = [
    ...
    '`track2_scratch/checkpoints/best_val/<best_run>/best_val.pt`\n',
    '\n',
    '**Prompts:** same 8 prompts as Track 1 (controlled comparison).\n',
    '\n',
    '**Outputs produced:**\n',
    '- `track2_scratch/generations/track2_samples.md` -- 8 prompts x 2 decoding modes\n',
    '\n',
    '**After this cell:** commit track2_samples.md, review annotations manually,\n',
...
phase6_inspect_src = [
    ...
    "print(open('track2_scratch/generations/track2_samples.md').read())\n",
]
...
phase7_md = [
    ...
    'Also requires `shared_eval/track1_final_metrics.json` (already committed).\n',
    '\n',
    '**Outputs produced:**\n',
    '- `shared_eval/track2_final_metrics.json` -- copy of Phase 5 metrics\n',
    '- `shared_eval/track2_loss_curve.png` -- copy of Phase 5 curve\n',
...
with open('track2_scratch/track2_run.ipynb', 'w', encoding='utf-8') as f:
