...
- [ ] `slm_run.ipynb` created with working sync/install cells.
...
3. Save to `generations/slm_samples.md` with the same prompt/completion/annotation format as Track 1.
...
**Definition of Done:**
- [ ] `generations/slm_samples.md` with ≥5 prompt/completion pairs (ideally the same prompts as Track 1), annotated for memorization vs. incoherence vs. novel-plausible phrasing.
