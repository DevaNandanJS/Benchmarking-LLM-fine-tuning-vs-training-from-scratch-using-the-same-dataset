...
Mirrors finetuning_model/scripts/common.py exactly in interface but with
TRACK_DIR pointing to slm_from_scratch/ — this is intentional and critical.
Do NOT import track1's common.py from here: its TRACK_DIR would resolve to
finetuning_model/, routing all logs and configs to the wrong track.
...
# Resolve upward: scripts/ → slm_from_scratch/ → llm_task/
...
def path(rel: str) -> Path:
    """Resolve a path relative to slm_from_scratch/ (robust to CWD)."""
