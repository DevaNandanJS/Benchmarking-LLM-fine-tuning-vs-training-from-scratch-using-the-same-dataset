...
Outputs (relative to repo root):
    slm_from_scratch/configs/run_phase4_<run_name>.json        \u2014 config dump pre-training
    slm_from_scratch/logs/<run_name>/metrics.jsonl             \u2014 step-level logging
    ...
    slm_from_scratch/checkpoints/last/<run_name>/last_ckpt.pt  \u2014 audit artifact
