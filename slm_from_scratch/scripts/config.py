...
TRACK_DIR:   Path = SCRIPTS_DIR.parent          # slm_from_scratch/
...
# ── Phase 2 — dataset ─────────────────────────────────────────────────────────
TRAIN_PT:              Path = PROCESSED_DIR / "slm_train.pt"
VAL_PT:                Path = PROCESSED_DIR / "slm_val.pt"
DATASET_STATS_JSON:    Path = PROCESSED_DIR / "slm_dataset_stats.json"
...
SLM_SAMPLES_MD:        Path = GENERATIONS_DIR / "slm_samples.md"
TRACK2_SAMPLES_MD:     Path = SLM_SAMPLES_MD
...
FINETUNING_FINAL_METRICS_JSON:Path = SHARED_EVAL_DIR / "finetuning_final_metrics.json"
TRACK1_FINAL_METRICS_JSON:   Path = FINETUNING_FINAL_METRICS_JSON
FINETUNING_LOSS_CURVE_PNG:   Path = SHARED_EVAL_DIR / "finetuning_loss_curve.png"
TRACK1_LOSS_CURVE_PNG:       Path = FINETUNING_LOSS_CURVE_PNG
SLM_SHARED_METRICS_JSON:     Path = SHARED_EVAL_DIR / "slm_final_metrics.json"
