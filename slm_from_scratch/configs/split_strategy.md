...
(tokens 82,704–97,298 of 97,299 total) is held out
for validation.  The remaining **85%** (tokens 0–82,703)
...
|---|---|---|---|---|
| **Train** | 128 | 50% | 645 | Maximises sample density from limited data |
| **Val** | 256 | 0% | 57 | Guarantees independent evaluation spans |

Applying 50% overlap to the ~14,595-token val region would yield
~114 chunks but only ~57
...
final train window's last token index is at most the boundary (82,704),
...
*Generated by build_dataset.py at 2026-08-13T12:45:29.000160+00:00*
