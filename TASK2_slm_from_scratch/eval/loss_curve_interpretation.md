...
| Metric | Value |
|---|---|
| Final mean CE loss (val) | 3.643046 nats |
| Perplexity | 38.2081 |
| Bits-per-byte (BPB) | 2.306906 |
| Track 1 BPB (for reference) | 1.309722 |
| BPB gap (Track 2 − Track 1) | 0.997184 |
...
- Counter-evidence: the loss DID decrease from 6.5418 to 1.2508,
...
Track 2 (from-scratch GPT) achieved **BPB = 2.306906**.
