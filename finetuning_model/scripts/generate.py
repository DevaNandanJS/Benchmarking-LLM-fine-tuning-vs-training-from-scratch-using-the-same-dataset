...
Output:
    finetuning_model/generations/finetuning_samples.md  — ≥8 prompt/completion pairs
...
Run on Colab (from repo root after git pull):
    !python finetuning_model/scripts/generate.py --run r8
...
def write_samples_md(prompts: list[str], sampled: list[str],
    ...
    """Write prompt/completion pairs to finetuning_samples.md."""
    lines = [
