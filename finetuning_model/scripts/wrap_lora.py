...
Outputs (relative to repo root):
  finetuning_model/configs/run_phase4_r4.json    — sweep config, r=4
  finetuning_model/configs/run_phase4_r8.json    — sweep config, r=8 (sanity run)
  finetuning_model/configs/run_phase4_r16.json   — sweep config, r=16
  finetuning_model/configs/trainable_params.json — required DoD deliverable
  (sanity_check_loss also recorded in trainable_params.json)

Run on Colab (from repo root after git pull):
  !python finetuning_model/scripts/wrap_lora.py
