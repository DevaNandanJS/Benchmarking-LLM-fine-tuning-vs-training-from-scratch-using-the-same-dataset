...
# Resolve upward from this file: scripts/ → TASK1_finetuning_model/ → llm_task/
...
TRAIN_PT: Path = PROCESSED_DIR / "finetune_train.pt"
VAL_PT: Path = PROCESSED_DIR / "finetune_val.pt"
...
FINETUNING_SAMPLES_MD: Path = GENERATIONS_DIR / "finetuning_samples.md"
TRACK1_SAMPLES_MD: Path = FINETUNING_SAMPLES_MD
