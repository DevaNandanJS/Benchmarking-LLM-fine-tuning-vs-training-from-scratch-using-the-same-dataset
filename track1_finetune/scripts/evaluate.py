...
Outputs:
    track1_finetune/eval/loss_curve.png              — train+val loss vs step
    track1_finetune/eval/final_metrics.json          — loss, perplexity, BPB
    track1_finetune/eval/loss_curve_interpretation.md — 3-5 sentence interpretation
...
Run on Colab (from repo root after git pull):
    !python track1_finetune/scripts/evaluate.py --run r8  # or whichever is best
