...
Outputs (relative to track1_finetune/):
  data/processed/track1_train.pt      — {"input_ids": LongTensor[N,256],
                                          "labels":    LongTensor[N,256]}
  data/processed/track1_val.pt        — same schema, val chunks
...
def main() -> None:
    ...
    **Script:** `track1_finetune/scripts/build_dataset.py`
