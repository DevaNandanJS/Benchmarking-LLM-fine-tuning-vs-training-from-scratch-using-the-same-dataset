...
> Last updated by compare.py: 2026-08-14T06:04:02.020375+00:00
...
| **Track 2** | GPT-from-scratch | Train from random init | **2.306973** | 38.2121 | 3.643151 |

**BPB gap (Track 2 − Track 1):** +0.997251 bits/byte

Track 2 is **0.9973 bits/byte worse** than Track 1. This gap quantifies the
...
- **Quality (BPB):** 0.9973 bits/byte better — the pretrained model's
...
*Generated by `TASK2_slm_from_scratch/scripts/compare.py` at 2026-08-14T06:04:02.020398+00:00*